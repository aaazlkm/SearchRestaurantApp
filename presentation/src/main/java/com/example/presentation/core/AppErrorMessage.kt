...
fun Throwable.getReadableMessage(context: Context): String = when (this) {
    is AppError.Api.NetworkException -> context.getString(R.string.error_network)
    is AppError.Api.TimeoutException -> context.getString(R.string.error_network)
    is AppError.Api.HttpException -> context.getString(R.string.error_network)
    is AppError.Api.HotpepperException -> when (this.errors.first()) {
